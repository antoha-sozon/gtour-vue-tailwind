<template>
  <main>
    ...
    <section class="md:flex md:flex-wrap md:-mx-4">
      <article
        class="relative overflow-hidden flex flex-wrap -mx-4 pt-8 pb-4 px-4 text-white bg-cover bg-center md:w-1/2 md:mx-0 lg:w-1/3"
